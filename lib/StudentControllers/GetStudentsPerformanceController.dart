...
class Getstudentsperformancecontroller extends GetxService {
  final Mainexamsrepo mainexamsrepo;

  Getstudentsperformancecontroller({required this.mainexamsrepo});

  bool _isLoading = false;

  bool get isLoading => _isLoading;

  Future<Responsemodal> getStudentPerformance(int Examid) async {
    _isLoading = true;
    Response response = await mainexamsrepo.getStudentPerformance(Examid);
